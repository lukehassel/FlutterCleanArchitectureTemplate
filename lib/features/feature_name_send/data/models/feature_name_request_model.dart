...
class FeatureNameRequestModel extends FeatureNameRequestEntity {
  FeatureNameRequestModel.fromEntity(FeatureNameRequestEntity e) {
    this.page = e.page;
    this.total = e.total;
    this.ad = e.ad;
  ...
  FeatureNameRequestModel.fromJson(Map<String, dynamic> json) {
    page = json['page'];
